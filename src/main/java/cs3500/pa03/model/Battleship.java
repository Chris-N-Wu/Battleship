...
/**
 * Implements Ship for a Battleship
 */
public class Battleship implements Ship {
  ...
  public void addCoordinate(Coord coord) {
    ...
    if (this.placementCoordinates.size() > ShipType.BATTLESHIP.getLength()) {
      throw new IllegalStateException(
          "A Carrier Can Only Fill " + ShipType.BATTLESHIP.getLength() + " Slots");
    }
  }
