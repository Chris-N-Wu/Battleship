...
public class Carrier implements Ship {
  ...
  public void addCoordinate(Coord coord) {
    ...
    if (this.placementCoordinates.size() > ShipType.CARRIER.getLength()) {
      throw new IllegalStateException(
          "A Carrier Can Only Fill " + ShipType.CARRIER.getLength() + " Slots");
    }
  }
