...
/**
 * Implements Ship for a Destroyer
 */
public class Destroyer implements Ship {
  ...
  public void addCoordinate(Coord coord) {
    ...
    if (this.placementCoordinates.size() > ShipType.DESTROYER.getLength()) {
      throw new IllegalStateException(
          "A Carrier Can Only Fill " + ShipType.DESTROYER.getLength() + " Slots");
    }
  }
